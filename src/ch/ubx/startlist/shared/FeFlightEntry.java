...
@Subclass
public class FeFlightEntry extends FeNode<FeFlightEntry, FeDate> implements Serializable, Comparable<FeFlightEntry> {
    ...
    public FeFlightEntry(String pilot, long startTimeInMillis, long endTimeGliderInMillis, boolean training, String remarks, String place) {
        this.pilot = pilot;
    ...
    public int compareTo(FeFlightEntry other) {
    ...
    public int compareToMajor(FeFlightEntry other) {
    ...
    public FeFlightEntry copy() {
        FeFlightEntry copy = new FeFlightEntry();
        copy.setId(getId());
