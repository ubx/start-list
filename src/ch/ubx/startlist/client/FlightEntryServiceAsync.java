...
public interface FlightEntryServiceAsync {
	...
	void addFlightEntry(FlightEntry flightEntry, AsyncCallback<FlightEntry> callback);
	...
	void updateFlightEntry(FlightEntry flightEntry, AsyncCallback<FlightEntry> callback);
