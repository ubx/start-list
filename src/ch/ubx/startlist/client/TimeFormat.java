...
public interface TimeFormat {
	...
	public static final DefaultFormat MM_HH_FORMAT = new DateBox.DefaultFormat(DateTimeFormat.getFormat("HH:mm"));
	...
	public static final DateTimeFormat TIME_FORMAT = DateTimeFormat.getFormat("HH:mm");
